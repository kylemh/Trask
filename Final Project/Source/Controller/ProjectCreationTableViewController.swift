...
class ProjectCreationTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func addProject() {
        ...
        do {
            ...
            let alertController = UIAlertController(title: "Empty Text Fields", message: "Please be certain you've named the project and given a name to every field.", preferredStyle: .Alert)
